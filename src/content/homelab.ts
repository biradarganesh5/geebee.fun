 ...
 * Req 4.2: a mini PC cluster connected through an 8-port gigabit switch.
 ...
 * 8-port gigabit switch), and Req 4.3 (i5 master node + worker mini PCs
...
export const homelabComponents: HomelabComponent[] = z
  ...
  .parse([
    ...
    },
    {
      ...
      description:
        'A cluster of mini PCs networked together through an 8-port gigabit switch, giving every node fast wired connectivity for clustered workloads and inter-node traffic.',
    },
    {
      id: 'k3s-proxmox-nodes',
      title: 'k3s + Proxmox Nodes',
      description:
        'An i5 mini PC acts as the main master node, with additional mini PCs joining as worker nodes. Together they run k3s for lightweight Kubernetes orchestration and Proxmox for virtualization.',
    },
  ]);
